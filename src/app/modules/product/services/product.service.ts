...
import { IProductModel, ProductModel } from '../../core/models/product.model';
...
export class ProductService {
  ...
  constructor() {
    this.products = [
      new ProductModel("Harley-Davidson Fat Bob FXDF 2009", "то мощный Dark Custom с впечатляющими пропорциями! Как и подобает настоящему кастому, он имеет массивный руль, что делает его похожим на гоночного монстра для дрэг-рейсинга.", "https://cdn2.riastatic.com/photosnew/auto/photo/harley-davidson_fat-bob__250723392fx.webp", 15000, true, Category.Chopper),
